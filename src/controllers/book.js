...
module.exports.postBook = async function(req, res) {  console.log('postBook------');
...
module.exports.deleteBook = async function(req, res) {console.log('deleteBook------');
...
module.exports.updateBook = async function(req, res) { console.log('updateBook------');
